...
public class JDialogVoiceTalk extends javax.swing.JDialog {
    ...
    public JDialogVoiceTalk(java.awt.Frame parent, boolean modal, NativeLong lUserID, HCNetSDK.NET_DVR_DEVICEINFO_V30 strDeviceInfo) 
    {
        ...
        try
        {
            ...
            fLocal = new FileWriter("E:\\local.264");
            fDevice = new FileWriter("E:\\device.264");
	...
	//这里采用全局的句柄进行操作,因为子对话框销毁后语音对讲还可以进行,用全局的变量保存句柄
        Jframe主预览1.g_lVoiceHandle = hCNetSDK.NET_DVR_StartVoiceCom_V30(m_lUserID, m_iSel+1, jComboBoxDataType.getSelectedIndex() == 1, fVoiceDataCallBack,  null);
	if ( Jframe主预览1.g_lVoiceHandle.intValue() == -1)
	{
    ...
    {//GEN-HEADEREND:event_jButtonStopActionPerformed
       if ( Jframe主预览1.g_lVoiceHandle.intValue() >= 0)
	{
		if (hCNetSDK.NET_DVR_StopVoiceCom( Jframe主预览1.g_lVoiceHandle))
		{
			Jframe主预览1.g_lVoiceHandle.setValue(-1);
		}
		else
		{
